    ...
    <div className="text-left">
      ...
      {items.length === 0 ? (
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_320px]">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-3">
                      ...
                      <div className="join border border-base-300">
                        <button
                          type="button"
                          className="join-item  btn btn-sm gap-0 px-2.5"
                          onClick={() =>
          ...
          <aside className="card border-base-300 bg-base-100 p-6 shadow-sm">
            ...
            <Show when="signed-in">
              <button
                ...
                className="btn btn-primary gap-2 mt-2 w-full"
              >
                {checkoutLoading ? (
                  <span
            ...
            <p className="mt-4 flex items-center gap-2 text-sm text-base-content/60">
              <HeadphonesIcon
                className="size-3.5 mt-0.5 shrink-0 text-primary"
                aria-hidden
              />
              <span>
                After payment, open your order for <strong>support chat</strong>
